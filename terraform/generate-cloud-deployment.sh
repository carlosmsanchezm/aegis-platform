...
# Note: This script only deploys the hub platform services (platform-api,
# proxy, Keycloak, Backstage, ingress). Projects, clusters, and spokes are
# created through the UI or API — not by this script.
